        ...
        <Container>
          <Toolbar sx={{ py: 2.5, px: `0 !important` }}>
            ...
            <Stack direction="row" sx={{ gap: { xs: 1.5, md: 2.5 }, display: { xs: 'none', sm: 'flex' } }}>
              ...
              <Button color="inherit" component={Link} href="https://vsingles.club" target="_blank">
                Documentation
              </Button>
              <Button component={Link} href="https://vsingles.club" disableElevation variant="contained" color="secondary">
                Purchase Now
              </Button>
            </Stack>
